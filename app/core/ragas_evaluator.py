...
class RAGASEvaluator(LoggerMixin):
    ...
    def __init__(self):
        ...
        self.embeddings = GoogleGenerativeAIEmbeddings(
            ...
            google_api_key=self.settings.googleapikey,
        )
    ...
    async def aevaluate(
        ...
        """
        self.logger.debug(f"Starting evaluation for question: {question[:100]}...")
    ...
    def _handle_evaluation_error(self, error: Exception) -> dict[str, Any]:
        ...
        """
        self.logger.error(f"Returning fallback scores due to error: {error}")
